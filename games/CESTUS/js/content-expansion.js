...
Object.assign(MODULE_TYPES, {
  ...
  chrono_anchor: {
    ...
    stasisFactor: 0.03, stasisDuration: 1800, mechanic: 'STASE', visual: 'hourglass', group: 'control',
  ...
  bossbreaker: {
    ...
    bossMult: 4, mechanic: 'ANTI-BOSS', visual: 'hex', group: 'kinetic',
  ...
  kinetic_battery: {
    ...
    chargeEvery: 6, chargeMult: 7, mechanic: 'TIR CHARGÉ', visual: 'battery', group: 'kinetic',
  ...
  phase_repeater: {
    ...
    hp: 85, dmg: 13, range: 6.2, fireRate: 105, isShooter: true, isBeam: true,
...
WAVE_SPAWN_WEIGHTS.late.push(
  ...
  {type:'siphon',w:0.06}, {type:'berserker',w:0.08}, {type:'juggernaut',w:0.05}
);
